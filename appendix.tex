...
\end{equation}
Therefore, the ratio of secondary case production caused by asymptomatic vs.~symptomatic
...
\begin{figure*}[!ht]
\begin{center}
\includegraphics[width=0.4\textwidth]{figheatmap_02.pdf}
\mbox{\hspace{0.05\textwidth}}
\includegraphics[width=0.4\textwidth]{figheatmap_R0_02.pdf}
...
Here, we assume $1/r=7$ days, $\bar G_s=7$ days, and $\kappa_s=\kappa_a=0.2$.
}
\end{center}
\end{figure*}
...
See Figure 1 in the main text for figure caption.
Here, we assume $1/r=7$ days, $\bar G_s=7$ days, and $\kappa_s=\kappa_a=0.8$.
}
\end{center}
\end{figure*}
...
As our baseline parameters, we assume $1/r=7$ days, $\bar G_s=G_a=7$ days, and $\kappa_s=0.5$.}
\end{center}
\end{figure*}
