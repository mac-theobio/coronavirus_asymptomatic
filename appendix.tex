...
$i(t)$ & total incidence\\
$i_a(t)$ & incidence of asymptomatic cases\\
$i_s(t)$ & incidence of symptomatic cases\\
$\mathcal R_0$ & basic reproduction number\\
$\mathcal R_a$ & asymptomatic intrinsic reproduction number\\
$\mathcal R_s$ & symptomatic intrinsic reproduction number\\
$g(\tau)$ & intrinsic generation-interval distribution\\
$g_a(\tau)$ & asymptomatic intrinsic generation-interval distribution\\
$g_s(\tau)$ & symptomatic intrinsic generation-interval distribution\\
$\bar G_a$ & mean asymptomatic generation interval\\
$\bar G_s$ & mean symptomatic generation interval\\
$\kappa_a$ & asymptomatic generation-interval dispersion\\
$\kappa_s$ & symptomatic generation-interval dispersion\\
...
\begin{figure*}[!ht]
\begin{center}
\includegraphics[width=0.8\textwidth]{figheatmap_diff.pdf}
\caption{Differences in the realized and the intrinsic proportions of asymptomatic transmission.
