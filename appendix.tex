...
Consider a SEIR model variant in which an infected individual can be either asymptomatic, $I_a$, or symptomatic, $I_s$.
...
Here, we vary relative generation-interval dispersion of asymptomatic cases, $\kappa_a/\kappa_s$, while assuming $G_a = G_s$.
