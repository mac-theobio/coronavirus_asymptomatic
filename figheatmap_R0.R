...
g0 <- ggplot(figdata) +
  ...
  geom_point(aes(x=1, y=example_z, fill=example_R02), size=5, col="black", shape=21, stroke=1) +
  geom_text(aes(x=1*1.5, y=example_z+0.05, label="underestimated")) +
  geom_text(aes(x=1/1.5, y=example_z+0.05, label="overestimated")) +
