...
\begin{figure*}[b!]
\begin{center}
\includegraphics[width=0.4\textwidth]{group/figheatmap_seird_noname.pdf}
\mbox{\hspace{0.05\textwidth}}
\includegraphics[width=0.44\textwidth]{group/figheatmap_seirdR0_noname.pdf}\\
\mbox{}\\
\includegraphics[width=0.4\textwidth]{group/figheatmap_seird_2_noname.pdf}
\mbox{\hspace{0.05\textwidth}}
\includegraphics[width=0.44\textwidth]{group/figheatmap_seird_R02_noname.pdf}
